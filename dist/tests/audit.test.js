...
exports.runAuditTest = runAuditTest;
 ...
 */
async function runAuditTest(baseUrl) {
    ...
    const assertInPendingQueue = pendingList.some((r) => r.reviewId === settlementRecord.reservationId);
